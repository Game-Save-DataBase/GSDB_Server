...
const PlatformSchema = new mongoose.Schema({
    ...
    generation: { type: Number },    //generacion de la consola
    ...
    logo: { type: String }, //url del logo extraido de la base de datos de logos de igdb
    family: { type: String }, //familia extraida de la base de datos de familia (name)
